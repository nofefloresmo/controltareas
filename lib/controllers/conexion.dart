...
class Conexion {
  ...
  static Future<void> script(Database db) async {
    ...
    await db.execute(
        'CREATE TABLE TAREA (IDTAREA INT PRIMARY KEY AUTOINCREMENT, IDMATERIA TEXT NOT NULL, F_ENTREGA TEXT NOT NULL, DESCRIPCION TEXT NOT NULL, FOREIGN KEY (IDMATERIA) REFERENCES MATERIA(IDMATERIA) ON DELETE CASCADE ON UPDATE CASCADE)');
  }
